export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
        Text documents are often broken up into....
      </div>
      <div id="wd-p-tag">
        <h4>Paragraph Tag</h4>
        <p id="wd-p-1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Season meat.</li>
          <li>Cook meat until done.</li>
          <li>Toast tortillas </li>
          <li>Cut up tomatoes and cilantro</li>
          <li>Assemble tacos with lettuce and cheese.</li>
        </ol>
        My favorite books (in no particular order):
        <ul id="wd-fav-books">
          <li>Hail Mary</li>
          <li>Norweigan Wood</li>
      ...
      <div id="wd-image">
        ...
        <br />
        <img src="images/teslabot.jpeg" width="400px" height="300px" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
